...
export default function TradeEntryPage() {
  ...
  const toggleVoice = () => {
    ...
    r.onresult = (e) => {
      ...
      setPipText(prev => prev ? `${prev} ${transcript}` : transcript);
    };
        ...
        <div className="form-section">
          ...
          <div className="form-field" style={{ position: 'relative' }}>
            ...
            <button
              ...
              onClick={toggleVoice}
              title={listening ? 'Stop recording' : 'Speak your trade'}
            >
              {listening ? (
          ...
          {listening && <p className="mic-hint">Listening... tap the mic to stop.</p>}
